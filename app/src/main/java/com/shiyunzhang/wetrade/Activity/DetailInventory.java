...
import com.shiyunzhang.wetrade.Adapter.ConditionAndQuantityAdapter;
            ...
            .addOnSuccessListener(documentSnapshot -> {
                ...
                if(item.getConditionAndQuantities() != null) {
                    ...
                    if (quantity == 0) {
                        ...
                        findViewById(R.id.create_auction).setEnabled(false);
                    } else {
    ...
    public void createAuction(View view) {
        ...
        mBuilder.setPositiveButton("Start Auction", (dialog, which) -> {
            if(priceView.getText().toString().isEmpty()){
                ...
                auction.setAuctionStatus("In Progress");
